	...
	<div class="container">
		...
		<form method="post" action="writeAction.jsp">
			<table class="table table-striped"<%-- 홀짝 줄무늬 --%> style="text-align:center; border:1px solid #dddddd ">
				<thead> <%--table의 제목부분 --%>
					<tr>
						<th colspan="2"<%-- 2개만큼의 열을 이용 --%> style="background-color: #eeeeee; text-align:center;"><%=clubName %> 게시판 글쓰기</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td><input type="text" class="form-control" placeholder="글제목" name="bbsTitle" maxlegth="50"></td>
					</tr>
					<tr>
						<td><textarea class="form-control" placeholder="글제목" name="bbsContent" maxlegth="2048" style="height:350px;"></textarea></td>
					</tr>
				</tbody>
			</table>
